...
PAGES = [
    {
        ...
        "links": [
            ("/install/index.html", "Back to install hub"),
            ("/install/npm/index.html", "npm install guide"),
            ("/troubleshooting/command-not-found/index.html", "Command not found fix"),
        ],
        ...
        "zh_links": [
            ("/zh/install/index.html", "返回安装总页"),
            ("/zh/install/npm/index.html", "npm 安装"),
            ("/zh/troubleshooting/command-not-found/index.html", "command not found 修复"),
        ],
    },
    {
        ...
        "links": [
            ("/install/index.html", "Back to install hub"),
            ("/troubleshooting/release-binaries/index.html", "Release binaries guide"),
            ("/troubleshooting/command-not-found/index.html", "Command not found fix"),
        ],
        ...
        "zh_links": [
            ("/zh/install/index.html", "返回安装总页"),
            ("/zh/troubleshooting/release-binaries/index.html", "Release binaries 页面"),
            ("/zh/troubleshooting/command-not-found/index.html", "command not found 修复"),
        ],
    },
    {
        ...
        "links": [
            ("/config/index.html", "Back to config hub"),
            ("/config/file-location/index.html", "Config file location"),
            ("/config/environment-variables/index.html", "Environment variables"),
        ],
        ...
        "zh_links": [
            ("/zh/config/index.html", "返回配置总页"),
            ("/zh/config/file-location/index.html", "配置文件位置"),
            ("/zh/config/environment-variables/index.html", "环境变量"),
        ],
    },
    {
        "slug": "provider-cost",
        ...
        "links": [
            ("/guides/pricing-and-cost/index.html", "Pricing and cost guide"),
            ("/config/provider-setup/index.html", "Provider setup"),
            ("/modes/plan-vs-yolo/index.html", "Plan mode vs yolo mode"),
        ],
        ...
        "zh_links": [
            ("/zh/guides/pricing-and-cost/index.html", "pricing / cost 页面"),
            ("/zh/config/provider-setup/index.html", "provider 设置"),
            ("/zh/modes/plan-vs-yolo/index.html", "plan vs yolo"),
        ],
    },
    {
        ...
        "links": [
            ("/mcp/index.html", "Back to MCP hub"),
            ("/mcp/server-examples/index.html", "MCP server examples"),
            ("/troubleshooting/provider-troubleshooting/index.html", "Provider troubleshooting"),
        ],
        ...
        "zh_links": [
            ("/zh/mcp/index.html", "返回 MCP 总页"),
            ("/zh/mcp/server-examples/index.html", "MCP server examples"),
            ("/zh/troubleshooting/provider-troubleshooting/index.html", "provider 排错"),
        ],
    },
]
...
def page_html(page: dict, zh: bool = False) -> str:
    ...
    brand_home = "/zh/index.html" if zh else "/index.html"
    ...
    alt_en = f"{DOMAIN}/{page['section']}/{page['slug']}/index.html"
    alt_zh = f"{DOMAIN}/zh/{page['section']}/{page['slug']}/index.html"
    canonical = alt_zh if zh else alt_en
    lang_switch = '<a href="/index.html">English</a>' if zh else '<a href="/zh/index.html">中文</a>'
    nav = (
        f'<a href="{prefix}/index.html">{home_label}</a>'
        f'<a href="{prefix}/guides/index.html">{"指南" if zh else "Guides"}</a>'
        f'<a href="{prefix}/docs/index.html">{"文档" if zh else "Docs"}</a>'
        f'<a href="{prefix}/install/index.html">{"安装" if zh else "Install"}</a>'
        f'<a href="{prefix}/config/index.html">{"配置" if zh else "Config"}</a>'
        f'<a href="{prefix}/modes/index.html">{"模式" if zh else "Modes"}</a>'
        f'<a href="{prefix}/comparisons/index.html">{"对比" if zh else "Comparisons"}</a>'
        f'<a href="{prefix}/troubleshooting/index.html">{"排错" if zh else "Troubleshooting"}</a>'
        f"{lang_switch}"
    )
    ...
    footer_links2 = (
        f'<a href="{prefix}/about/index.html">{"关于" if zh else "About"}</a>'
        f'<a href="{prefix}/contact/index.html">{"联系" if zh else "Contact"}</a>'
    )
...
def update_hubs() -> None:
    ...
    old = '</div>\n    </section>'
    new = '<article class="content-card"><span class="tag">Windows</span><h3>Install DeepSeek TUI on Windows</h3><p>Use this page when shell defaults, PowerShell, Git Bash, or WSL make the install route feel less obvious than macOS examples suggest.</p><a href="/install/windows/index.html">Open Windows install guide</a></article>\n        <article class="content-card"><span class="tag">Update</span><h3>Update or upgrade DeepSeek TUI</h3><p>Use this page when the real issue is not first install, but how to keep the active command current without mixing package paths.</p><a href="/install/update-or-upgrade/index.html">Open update guide</a></article>\n      </div>\n    </section>'
    ...
    old = '</div></div></section>\n  <footer'
    new = '<article class="content-card"><span class="tag">Windows</span><h3>在 Windows 上安装 DeepSeek TUI</h3><p>如果 PowerShell、Git Bash 或 WSL 让安装路线不那么直观，这页更适合先看。</p><a href="/zh/install/windows/index.html">打开 Windows 安装</a></article>\n<article class="content-card"><span class="tag">更新</span><h3>更新或升级 DeepSeek TUI</h3><p>如果你想确认当前命令到底该通过哪条路径更新，这页更直接。</p><a href="/zh/install/update-or-upgrade/index.html">打开更新页</a></article>\n</div></div></section>\n  <footer'
    zh_install.write_text(replace_once(text, old, new), encoding="utf-8")

    config = ROOT / "config" / "index.html"
    text = config.read_text(encoding="utf-8")
    old = '<article class="content-card"><span class="tag">Advanced</span><h3>MCP and skills build on config</h3><p>Do not jump into advanced workflows before the core auth and runtime path is stable.</p><a href="/mcp/index.html">Open MCP guide</a></article></div></section></main>'
    new = '<article class="content-card"><span class="tag">Reset</span><h3>Reset DeepSeek TUI config</h3><p>Use this page when the current config state is so tangled that a clean reset is more efficient than more patching.</p><a href="/config/reset/index.html">Open config reset guide</a></article><article class="content-card"><span class="tag">Cost</span><h3>Provider cost</h3><p>Use this page when your pricing question is really about which provider meters the usage behind DeepSeek TUI.</p><a href="/config/provider-cost/index.html">Open provider cost guide</a></article><article class="content-card"><span class="tag">Advanced</span><h3>MCP and skills build on config</h3><p>Do not jump into advanced workflows before the core auth and runtime path is stable.</p><a href="/mcp/index.html">Open MCP guide</a></article></div></section></main>'
    ...
    old = '<article class="content-card"><span class="tag">MCP</span><h3>MCP 前置理解</h3><p>很多用户会把高级能力和基础配置混在一起，先分清楚会更快。</p><a href="/zh/mcp/index.html">打开 MCP 页</a></article>\n</div></div></section>'
    new = '<article class="content-card"><span class="tag">重置</span><h3>重置 DeepSeek TUI 配置</h3><p>如果当前配置状态已经难以信任，这页会比继续零碎排查更实用。</p><a href="/zh/config/reset/index.html">打开配置重置</a></article>\n<article class="content-card"><span class="tag">成本</span><h3>Provider 成本</h3><p>如果你问的是 DeepSeek TUI 多少钱，这页会把问题拉回真正的 provider 计费层。</p><a href="/zh/config/provider-cost/index.html">打开 provider 成本</a></article>\n<article class="content-card"><span class="tag">MCP</span><h3>MCP 前置理解</h3><p>很多用户会把高级能力和基础配置混在一起，先分清楚会更快。</p><a href="/zh/mcp/index.html">打开 MCP 页</a></article>\n</div></div></section>'
    ...
    old = '<article class="content-card"><span class="tag">Binaries</span><h3>Release binaries</h3><p>If package-manager friction is the issue, the release-binary route may be the cleaner path.</p><a href="/troubleshooting/release-binaries/index.html">Open release binaries guide</a></article></div></section></main>'
    new = '<article class="content-card"><span class="tag">Binaries</span><h3>Release binaries</h3><p>If package-manager friction is the issue, the release-binary route may be the cleaner path.</p><a href="/troubleshooting/release-binaries/index.html">Open release binaries guide</a></article><article class="content-card"><span class="tag">MCP</span><h3>MCP troubleshooting</h3><p>Use this page when MCP feels broken and you need to separate server-level failures from basic config mistakes.</p><a href="/troubleshooting/mcp-troubleshooting/index.html">Open MCP troubleshooting</a></article></div></section></main>'
    ...
    old = '<article class="content-card"><span class="tag">API Key</span><h3>API Key 与 provider</h3><p>如果命令存在但无法使用，配置线通常比安装线更关键。</p><a href="/zh/config/api-key/index.html">打开 API Key 页</a></article>\n</div></div></section>'
    new = '<article class="content-card"><span class="tag">API Key</span><h3>API Key 与 provider</h3><p>如果命令存在但无法使用，配置线通常比安装线更关键。</p><a href="/zh/config/api-key/index.html">打开 API Key 页</a></article>\n<article class="content-card"><span class="tag">MCP</span><h3>MCP 排错</h3><p>如果你怀疑是 MCP 坏了，这页会先帮你分清楚是不是基础配置没稳。</p><a href="/zh/troubleshooting/mcp-troubleshooting/index.html">打开 MCP 排错</a></article>\n</div></div></section>'
...
def update_nav_and_docs_hubs() -> None:
    ...
    if "Quick Routes" not in text:
        insert = '<section class="section section-alt"><div class="container"><div class="section-head"><h2>Quick Routes</h2><p>Start with the doc family that matches your immediate question instead of browsing the whole repo tree.</p></div><div class="card-grid card-grid-3"><article class="content-card"><span class="tag">Setup</span><h3>Install and configuration first</h3><p>If your current blocker is first-run setup, start with install docs, configuration docs, and MCP docs before you read architecture pages.</p><a href="/docs/install/index.html">Open install docs</a></article><article class="content-card"><span class="tag">Usage</span><h3>Modes, keybindings, and tool surface</h3><p>If DeepSeek TUI is already running, move into modes, keybindings, runtime API, and tool surface docs next.</p><a href="/docs/modes/index.html">Open usage docs</a></article><article class="content-card"><span class="tag">Maintainers</span><h3>Architecture, runbooks, and release context</h3><p>Use the architecture and runbook docs when you care about internals, release flow, or historical implementation context.</p><a href="/docs/architecture/index.html">Open architecture docs</a></article></div></div></section>'
    ...
    if "快速路线" not in text:
        insert = '<section class="section section-alt"><div class="container"><div class="section-head"><h2>快速路线</h2><p>先按当前问题进入对应文档线，而不是从头翻完整个仓库文档目录。</p></div><div class="card-grid card-grid-3"><article class="content-card"><span class="tag">上手</span><h3>先看安装与配置</h3><p>如果你现在卡在首次运行，优先看安装文档、配置文档和 MCP 文档，而不是直接跳架构页。</p><a href="/zh/docs/install/index.html">打开安装文档</a></article><article class="content-card"><span class="tag">使用</span><h3>模式、快捷键与工具边界</h3><p>如果 DeepSeek TUI 已经能跑，下一步更值得看模式、快捷键、运行时 API 和工具边界。</p><a href="/zh/docs/modes/index.html">打开使用文档</a></article><article class="content-card"><span class="tag">维护</span><h3>架构、runbook 与版本背景</h3><p>如果你更关心内部结构、发布流程或历史实现背景，就从架构和 runbook 线切入。</p><a href="/zh/docs/architecture/index.html">打开架构文档</a></article></div></div></section>'
...
def update_sitemap() -> None:
    ...
    additions = []
    for page in PAGES:
        additions.append(f'  <url><loc>{DOMAIN}/{page["section"]}/{page["slug"]}/index.html</loc><lastmod>{DATE}</lastmod></url>')
        additions.append(f'  <url><loc>{DOMAIN}/zh/{page["section"]}/{page["slug"]}/index.html</loc><lastmod>{DATE}</lastmod></url>')
    block = "\n".join(additions) + "\n"
